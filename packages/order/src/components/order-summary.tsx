import type { OrderTotals } from '@oceanfresh/shared';
...
export function OrderSummary({ totals, itemCount, className = '' }: OrderSummaryProps) {
  return (
    <section className={`rounded-lg border border-gray-200 bg-white p-4 ${className}`} aria-label="Order summary">
