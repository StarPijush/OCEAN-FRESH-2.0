...
export class FirestoreCategoryRepository implements ICategoryRepository {
  async findById(id: string): Promise<Category | null> {
    try {
      ...
      throw new RepositoryError('Failed to find category by ID', 'findById', COLLECTION, {
        id,
        error: err,
      });
    }
  ...
  async findBySlug(slug: string): Promise<Category | null> {
    try {
      ...
      throw new RepositoryError('Failed to find category by slug', 'findBySlug', COLLECTION, {
        slug,
        error: err,
      });
    }
  ...
  async findByIds(ids: string[]): Promise<Category[]> {
    ...
    try {
      ...
      throw new RepositoryError('Failed to find categories by IDs', 'findByIds', COLLECTION, {
        ids,
        error: err,
      });
    }
  ...
  async findAll(query: CategoryQuery): Promise<PaginatedResult<Category>> {
    try {
      ...
      if (query.parentId !== undefined)
        constraints.push({ field: 'parentId', operator: '==', value: query.parentId });
      if (query.status) {
      ...
      if (query.visibility && query.visibility !== 'all')
        constraints.push({ field: 'visibility', operator: '==', value: query.visibility });
      if (query.featured !== undefined)
        constraints.push({ field: 'featured', operator: '==', value: query.featured });
      if (query.level !== undefined)
        constraints.push({ field: 'level', operator: '==', value: query.level });
      ...
      throw new RepositoryError('Failed to query categories', 'findAll', COLLECTION, {
        query,
        error: err,
      });
    }
  ...
  async findChildren(parentId: string): Promise<Category[]> {
    try {
      ...
      throw new RepositoryError('Failed to find children', 'findChildren', COLLECTION, {
        parentId,
        error: err,
      });
    }
  ...
  async findDescendants(categoryId: string): Promise<Category[]> {
    try {
      ...
      throw new RepositoryError('Failed to find descendants', 'findDescendants', COLLECTION, {
        categoryId,
        error: err,
      });
    }
  ...
  async findAncestors(categoryId: string): Promise<Category[]> {
    try {
      ...
      throw new RepositoryError('Failed to find ancestors', 'findAncestors', COLLECTION, {
        categoryId,
        error: err,
      });
    }
  ...
  async findFeatured(limit = 10): Promise<Category[]> {
    try {
      ...
      throw new RepositoryError('Failed to find featured categories', 'findFeatured', COLLECTION, {
        limit,
        error: err,
      });
    }
  ...
  async findTree(): Promise<Category[]> {
    try {
      ...
      throw new RepositoryError('Failed to find category tree', 'findTree', COLLECTION, {
        error: err,
      });
    }
  }
  ...
  async search(term: string, query?: Partial<CategoryQuery>): Promise<PaginatedResult<Category>> {
    try {
      ...
      throw new RepositoryError('Failed to search categories', 'search', COLLECTION, {
        term,
        error: err,
      });
    }
  ...
  async count(query?: Partial<CategoryQuery>): Promise<number> {
    try {
      ...
      if (query?.parentId !== undefined)
        constraints.push({ field: 'parentId', operator: '==', value: query.parentId });
      const docs = await firestoreService.query<Record<string, unknown>>(
        COLLECTION,
        constraints,
        {},
      );
      ...
      throw new RepositoryError('Failed to count categories', 'count', COLLECTION, {
        query,
        error: err,
      });
    }
  ...
  async create(
    ...
    try {
      ...
      throw new RepositoryError('Failed to create category', 'create', COLLECTION, {
        name: data.name,
        error: err,
      });
    }
  ...
  async update(
    ...
    try {
      ...
      throw new RepositoryError('Failed to update category', 'update', COLLECTION, {
        id,
        error: err,
      });
    }
  ...
  async move(
    ...
    try {
      ...
      throw new RepositoryError('Failed to move category', 'move', COLLECTION, {
        id,
  ...
  async softDelete(id: string): Promise<void> {
    try {
      ...
      if (err instanceof NotFoundError) throw err;
      throw new RepositoryError('Failed to soft-delete category', 'softDelete', COLLECTION, {
        id,
        error: err,
      });
    }
  ...
  async restore(id: string): Promise<void> {
    try {
      ...
      if (err instanceof NotFoundError) throw err;
      throw new RepositoryError('Failed to restore category', 'restore', COLLECTION, {
        id,
        error: err,
      });
    }
  ...
  async archive(id: string): Promise<void> {
    try {
      ...
      if (err instanceof NotFoundError) throw err;
      throw new RepositoryError('Failed to archive category', 'archive', COLLECTION, {
        id,
        error: err,
      });
    }
  ...
  async bulkUpdate(ids: string[], data: Partial<UpdateCategoryInput>): Promise<void> {
    try {
      ...
      throw new RepositoryError('Failed to bulk update categories', 'bulkUpdate', COLLECTION, {
        ids,
        error: err,
      });
    }
  ...
  async bulkArchive(ids: string[]): Promise<void> {
    try {
      ...
      throw new RepositoryError('Failed to bulk archive categories', 'bulkArchive', COLLECTION, {
        ids,
        error: err,
      });
    }
