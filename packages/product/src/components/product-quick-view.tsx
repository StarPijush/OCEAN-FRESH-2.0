...
export function ProductQuickView({ product, isOpen, onClose, className = '' }: ProductQuickViewProps) {
  if (!isOpen) return null;

  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center">
      <div className="fixed inset-0 bg-black/50" onClick={onClose} />
      <div className={`relative z-10 w-full max-w-lg rounded-lg bg-white p-6 shadow-xl mx-4 ${className}`}>
        <button
          type="button"
          onClick={onClose}
