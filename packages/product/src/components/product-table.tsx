...
export function ProductTable({ products, onEdit, onDelete, onArchive, onDuplicate, selectedIds, onSelect, className = '' }: ProductTableProps) {
            ...
            <tr key={product.id} className="hover:bg-gray-50">
              ...
              {(onEdit || onDelete || onArchive || onDuplicate) && (
                <td className="px-3 py-4 whitespace-nowrap text-right">
                  <ProductActions product={product} onEdit={onEdit} onDelete={onDelete} onArchive={onArchive} onDuplicate={onDuplicate} />
                </td>
              )}
            </tr>
          ))}
