...
export class FirestoreAuthRepository implements IAuthRepository {
  async findSessionById(sessionId: string): Promise<AuthSession | null> {
    try {
      ...
      throw new RepositoryError('Failed to find session', 'findSessionById', COLLECTIONS.sessions, {
        sessionId,
        error: err,
      });
    }
  ...
  async saveSession(session: AuthSession): Promise<void> {
    try {
      await firestoreService.set(
        COLLECTIONS.sessions,
        session.id,
        serializeSessionData(session as unknown as Record<string, unknown>),
      );
    } catch (err) {
      throw new RepositoryError('Failed to save session', 'saveSession', COLLECTIONS.sessions, {
  ...
  async updateSession(sessionId: string, data: Partial<AuthSession>): Promise<void> {
    try {
      await firestoreService.update(
        COLLECTIONS.sessions,
        sessionId,
        serializeSessionData(data as unknown as Record<string, unknown>),
      );
    } catch (err) {
      throw new RepositoryError('Failed to update session', 'updateSession', COLLECTIONS.sessions, {
        sessionId,
        error: err,
      });
    }
  ...
  async deleteSession(sessionId: string): Promise<void> {
    try {
      ...
      throw new RepositoryError('Failed to delete session', 'deleteSession', COLLECTIONS.sessions, {
        sessionId,
        error: err,
      });
    }
  ...
  async findDeviceById(deviceId: string): Promise<DeviceInfo | null> {
    try {
      ...
      throw new RepositoryError('Failed to find device', 'findDeviceById', COLLECTIONS.devices, {
        deviceId,
        error: err,
      });
    }
  ...
  async saveDevice(userId: string, device: DeviceInfo): Promise<void> {
    try {
      await firestoreService.set(`${COLLECTIONS.devices}`, device.id, {
        ...device,
        userId,
      } as unknown as Record<string, unknown>);
    } catch (err) {
      throw new RepositoryError('Failed to save device', 'saveDevice', COLLECTIONS.devices, {
        userId,
        deviceId: device.id,
        error: err,
      });
  ...
  async updateDevice(userId: string, deviceId: string, data: Partial<DeviceInfo>): Promise<void> {
    try {
      ...
      throw new RepositoryError('Failed to update device', 'updateDevice', COLLECTIONS.devices, {
        userId,
        deviceId,
        error: err,
      });
  ...
  async deleteDevice(userId: string, deviceId: string): Promise<void> {
    try {
      ...
      throw new RepositoryError('Failed to delete device', 'deleteDevice', COLLECTIONS.devices, {
        userId,
        deviceId,
        error: err,
      });
  ...
  async saveAuditLog(entry: AuditLogEntry): Promise<void> {
    try {
      ...
      throw new RepositoryError('Failed to save audit log', 'saveAuditLog', COLLECTIONS.auditLogs, {
        entryId: entry.id,
        error: err,
      });
    }
  ...
  async getUserById(userId: string): Promise<UserIdentity | null> {
    try {
      ...
      throw new RepositoryError('Failed to find user', 'getUserById', COLLECTIONS.users, {
        userId,
        error: err,
      });
    }
  ...
  async saveUser(user: UserIdentity): Promise<void> {
    try {
      ...
      throw new RepositoryError('Failed to save user', 'saveUser', COLLECTIONS.users, {
        userId: user.id,
        error: err,
      });
    }
  ...
  async updateUser(userId: string, data: Partial<UserIdentity>): Promise<void> {
    try {
      ...
      throw new RepositoryError('Failed to update user', 'updateUser', COLLECTIONS.users, {
        userId,
        error: err,
      });
    }
