...
export class SupabaseAuthRepository implements IAuthRepository {
  async findSessionById(sessionId: string): Promise<AuthSession | null> {
    try {
      ...
      throw new RepositoryError('Failed to find session', 'findSessionById', TABLES.sessions, {
        sessionId,
        error: err,
      });
    }
  ...
  async saveSession(session: AuthSession): Promise<void> {
    try {
      ...
      throw new RepositoryError('Failed to save session', 'saveSession', TABLES.sessions, {
  ...
  async updateSession(sessionId: string, data: Partial<AuthSession>): Promise<void> {
    try {
      ...
      throw new RepositoryError('Failed to update session', 'updateSession', TABLES.sessions, {
        sessionId,
        error: err,
      });
    }
  ...
  async deleteSession(sessionId: string): Promise<void> {
    try {
      ...
      throw new RepositoryError('Failed to delete session', 'deleteSession', TABLES.sessions, {
        sessionId,
        error: err,
      });
    }
  ...
  async findDeviceById(deviceId: string): Promise<DeviceInfo | null> {
    try {
      ...
      throw new RepositoryError('Failed to find device', 'findDeviceById', TABLES.devices, {
        deviceId,
        error: err,
      });
    }
  ...
  async saveDevice(userId: string, device: DeviceInfo): Promise<void> {
    try {
      ...
      throw new RepositoryError('Failed to save device', 'saveDevice', TABLES.devices, {
        userId,
        deviceId: device.id,
        error: err,
      });
  ...
  async updateDevice(userId: string, deviceId: string, data: Partial<DeviceInfo>): Promise<void> {
    try {
      ...
      throw new RepositoryError('Failed to update device', 'updateDevice', TABLES.devices, {
        userId,
        deviceId,
        error: err,
      });
  ...
  async deleteDevice(userId: string, deviceId: string): Promise<void> {
    try {
      ...
      throw new RepositoryError('Failed to delete device', 'deleteDevice', TABLES.devices, {
        userId,
        deviceId,
        error: err,
      });
  ...
  async saveAuditLog(entry: AuditLogEntry): Promise<void> {
    try {
      ...
      throw new RepositoryError('Failed to save audit log', 'saveAuditLog', TABLES.auditLogs, {
        entryId: entry.id,
        error: err,
      });
    }
  ...
  async findAuditLogs(userId: string, limit = 50): Promise<AuditLogEntry[]> {
    try {
      ...
      throw new RepositoryError('Failed to find audit logs', 'findAuditLogs', TABLES.auditLogs, {
        userId,
        error: err,
      });
    }
  ...
  async getUserById(userId: string): Promise<UserIdentity | null> {
    try {
      ...
      throw new RepositoryError('Failed to find user', 'getUserById', TABLES.users, {
        userId,
        error: err,
      });
    }
  ...
  async saveUser(user: UserIdentity): Promise<void> {
    try {
      ...
      throw new RepositoryError('Failed to save user', 'saveUser', TABLES.users, {
        userId: user.id,
        error: err,
      });
    }
  ...
  async updateUser(userId: string, data: Partial<UserIdentity>): Promise<void> {
    try {
      ...
      throw new RepositoryError('Failed to update user', 'updateUser', TABLES.users, {
        userId,
        error: err,
      });
    }
