...
export class CartErrorBoundary extends Component<CartErrorBoundaryProps, CartErrorBoundaryState> {
  state: CartErrorBoundaryState = { hasError: false, error: null };
      ...
      return (
        <div className="rounded-lg border border-red-200 bg-red-50 p-6 text-center" role="alert">
          <svg className="mx-auto h-12 w-12 text-red-400" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true">
            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1} d="M12 9v2m0 4h.01m-6.938 4h13.856c1.54 0 2.502-1.667 1.732-2.5L13.732 4c-.77-.833-1.965-.833-2.732 0L4.082 16.5c-.77.833.192 2.5 1.732 2.5z" />
          </svg>
          <h3 className="mt-2 text-sm font-semibold text-red-800">Cart Error</h3>
